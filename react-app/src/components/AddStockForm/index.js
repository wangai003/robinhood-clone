...
import { addStockToWatchlist, createWatchlist, searchStocks } from '../../store/watchlist';
...
const AddStockForm = ({ hideform,watchlist}) => {
    ...
    const onKeyDown = async (e) => {
        if (e.keyCode === 13) {
            ...
            let res = await dispatch(addStockToWatchlist(filteredStocks[activeSuggestionIndex],watchlist))
            hideform();
            }
...
/>
{showSuggestions && name && <SuggestionsList className="suggestions"
