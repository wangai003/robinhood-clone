...
const BankForm = () => {
  ...
  return (
    <>
      <div>
        {myBanks.length > 0 && <h2> My Linked Accounts: </h2>}

        {myBanks.length < 1 && <h2> Please add a bank account: </h2>}
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select name='bank_id' type='text' value={bank} onChange={updateBank} required={true}>
            {bankList.map(bank => (
        ...
        <div>
          ...
          <input name='name' type='text' placeholder='Name' value={name} onChange={updateName} />
        </div>
