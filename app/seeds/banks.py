...
banks = ['Chase', 'Wells Fargo', 'Bank of America', 'Capital One', 'Navy Federal Credit Union', 'USAA', 'U.S. Bank', 'Citibank', 'Chime', 'Citizens Bank', 'TD Bank', 'Ally Bank', 'Fidelity', 'Huntington Bank', 'Charles Swab']
